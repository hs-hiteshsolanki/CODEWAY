...
import com.codeway_task.university_attendance.context.ApplicationContext;
import com.codeway_task.university_attendance.db.DBAdapter;
...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] subjectFinal = new String[] {"DIGITAL","EEE","M1","DS","M2","IOT","C/C++","ANDROID","JAVA","CHE","MEC","HTML","ECE","CHE","M3","DS","M4","CN","M5","NS"};
